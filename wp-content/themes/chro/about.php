...
<div id="page-banner-area" class="page-banner-area" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/hero_area/banner_bg.jpg');'">
				...
				<div class="row">
					...
					<div class="col-lg-4 align-self-center">
						<div class="about-video">
							<img class="img-fluid" src="<?php echo get_template_directory_urifdskllk(); ?>/assets/images/about/about_img.jpg" alt="">
			...
			<div class="container">
				<div class="row">
					...
					<div class="col-lg-4">
						<div class="outcome-content">
							<div class="outcome-img overlay">
								<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/images/about/learn_img.jpg" alt="">
							</div>
					...
					<div class="col-lg-4">
						<div class="outcome-content">
							<div class="outcome-img overlay">
								<img class="" src="<?php echo get_template_directory_uri(); ?>/assets/images/about/connect_img.jpg" alt="">
							</div>
		...
		<!-- ts speaker start-->
		<section id="ts-speakers" class="ts-speakers" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker_bg.png');'">
			<div class="container">
				<div class="row">
                     ...
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker1.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
                              ...
                              <img class="company-logo" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor1.png" alt="">
                              <p>
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="500ms">
                  ...
                  <div id="popup_2" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker2.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="600ms">
                  ...
                  <div id="popup_3" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker3.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="700ms">
                  ...
                  <div id="popup_4" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker4.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="800ms">
                  ...
                  <div id="popup_5" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker5.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="900ms">
                  ...
                  <div id="popup_6" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker6.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1000ms">
                  ...
                  <div id="popup_7" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker7.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
               ...
               <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="1100ms">
                  ...
                  <div id="popup_8" class="container ts-speaker-popup mfp-hide">
                     <div class="row">
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-img">
                              <img src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker8.jpg" alt="">
                           </div>
                        </div><!-- col end-->
                        <div class="col-lg-6">
                           <div class="ts-speaker-popup-content">
            ...
            <div class="container">
                  ...
                  <div class="row sponsor-padding text-center">
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-1.png" alt="">
                           </a>
                     </div>
                     <!-- Col 1 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-2.png" alt="">
                           </a>
                     </div>
                     <!-- Col 2 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-3.png" alt="">
                           </a>
                     </div>
                     <!-- Col 3 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-4.png" alt="">
                           </a>
                     </div>
                     <!-- Col 3 end -->
                  </div>
               ...
               <div class="sponsors-wrap">
                  ...
                  <div class="row sponsor-padding text-center">
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-5.png" alt="">
                           </a>
                     </div>
                     <!-- Col 1 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-6.png" alt="">
                           </a>
                     </div>
                     <!-- Col 2 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-7.png" alt="">
                           </a>
                     </div>
                     <!-- Col 3 end -->
                     <div class="col-lg-3">
                        <a href="#" class="sponsors-logo">
                              <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor-8.png" alt="">
                           </a>
                     </div>
                     <!-- Col 3 end -->
                  </div>
