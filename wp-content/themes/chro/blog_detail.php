					...
					<div class="col-lg-10 mx-auto">
						<div class="blog-details">
							...
							<div class="post-media post-image text-center">
								<img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog-details.jpg" alt="">
							</div>
							<div class="post-content post-single">
								...
								<div class="author-box solid-bg mrb-40">
									<div class="author-img float-left">
										<img src="<?php echo get_template_directory_uri(); ?>/assets/images/avatar/author.jpg" alt="">
									</div>
								...
								<div class="comments-area" id="comments">
									...
									<ul class="comments-list">
										<li>
											<div class="comment">
												<img class="comment-avatar float-left" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/avatar/author2.jpg">
											...
											<ul class="comments-reply">
												<li>
													<div class="comment">
														<img class="comment-avatar float-left" alt="" src="<?php echo get_template_directory_uri(); ?>/assets/images/avatar/author3.jpg">
