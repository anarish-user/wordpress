...
<section class="hero-area centerd-item">
        <div class="banner-item" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/hero_area/banner2.jpg');'">
            <div class="container">
               <div class="row">
                  <div class="col-lg-8 mx-auto">
                     <div class="banner-content-wrap text-center">
                        ...
                        <div class="banner-btn">
                           <a href="/contact" class="btn">Buy Ticket</a>
                        </div>
      ...
      <!-- ts funfact start-->
      <section class="ts-funfact" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/funfact_bg.jpg');'">
         <div class="container">
            <div class="row">
      ...
      <!-- ts speaker start-->
      <section id="ts-speakers" class="ts-speakers speaker-classic" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker_bg.png');'">
         <div class="container">
            <div class="row">
            ...
            <div class="row">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     ...
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker1.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  ...
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker2.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker3.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker4.jpg" alt="">
             ...
             <!-- popup end-->
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker5.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker6.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker7.jpg" alt="">
               ...
               <div class="col-lg-3 col-md-6">
                  <div class="ts-speaker">
                     <div class="speaker-img">
                     <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker8.jpg" alt="">
         ...
         <img class="shap1" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis1.png" alt="">
<img class="shap2" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis2.png" alt="">
<img class="shap3" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis3.png" alt="">
        ...
        <section id="ts-experiences" class="ts-experiences">
            ...
            <div class="row">
               <div class="col-lg-6 no-padding">
                  <div class="exp-img" 
                  style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/cta_img.jpg');'">
                  </div>
               </div><!-- col end-->
                  ...
                  <div class="tab-content schedule-tabs schedule-tabs-item">
                        ...
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-left">
                                 <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker1.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-right">
                                 <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker2.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-left">
                                 <img class="schedule-slot-speakers" src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker3.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-right">
                                 <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker4.jpg" alt="">
                     ...
                     <div role="tabpanel" class="tab-pane" id="date2">
                        <div class="row">
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-left">
                              <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker5.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-right">
                              <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker6.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-left">
                              <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker7.jpg" alt="">
                           ...
                           <div class="col-lg-6">
                              <div class="schedule-listing-item schedule-right">
                              <img class="schedule-slot-speakers"  src="<?php echo get_template_directory_uri(); ?>/assets/images/speakers/speaker8.jpg" alt="">
      ...
      <!-- ts pricing start-->
      <section class="ts-pricing gradient" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/pricing/pricing_img.jpg');'">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
            ...
            <div class="row">
               <div class="col-lg-4">
                  ...
                  <img class="pricing-dot " src="<?php echo get_template_directory_uri(); ?>/assets/images/pricing/dot.png"alt="">
                  <div class="ts-pricing-box">
                     ...
                     <img class="pricing-dot1 " src="<?php echo get_template_directory_uri(); ?>/assets/images/pricing/dot.png"alt="">
                  </div>
               </div><!-- col end-->
               <div class="col-lg-4">
      ...
      <section class="ts-blog section-bg">
            ...
            <div class="row">
               <div class="col-lg-4">
                  <div class="post">
                     <div class="post-media post-image">
                        <a href="#">
                         <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog1.jpg" alt="">
                        </a>
                     </div>
               ...
               <div class="col-lg-4">
                  <div class="post">
                     <div class="post-media post-image">
                        <a href="#">
                        <img class="img-fluid" src="<?php echo get_template_directory_uri(); ?>/assets/images/blog/blog2.jpg" alt="">
                        </a>
                     </div>
         ...
         <!-- shap image-->
         <div class="speaker-shap">
            <img class="shap2" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/news_memphis2.png" alt="">
         </div>
      </section>
      <!-- ts blog end-->

      <!-- ts sponsors start-->
      <section class="ts-intro-sponsors" style="background-image: url('<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor_img.jpg');'">
         <div class="container">
            <div class="row">
               <div class="col-lg-12">
                  <h2 class="section-title white">
            ...
            <div class="row">
               <div class="col-lg-12">
                  <div class="sponsors-logo text-center">
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor1.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor2.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor3.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor4.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor5.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor6.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor7.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor8.png" alt=""></a>
                     <a href=""><img src="<?php echo get_template_directory_uri(); ?>/assets/images/sponsors/sponsor9.png" alt=""></a>
      ...
      <section class="ts-map-direction wow fadeInUp" data-wow-duration="1.5s" data-wow-delay="400ms">
         ...
         <div class="speaker-shap">
         <img class="shap1" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis3.png" alt="">
         <img class="shap2" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis2.png" alt="">
         <!-- <img class="shap3" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis4.png" alt=""> -->
         <img class="shap4" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/home_speaker_memphis1.png" alt="">
         </div>
      </section>
