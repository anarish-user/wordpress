 ...
 */
function chro_custom_colors_css() {
	$hue = absint( get_theme_mod( 'colorscheme_hue', 250 ) );

	/**
	 * Filters chro default saturation level.
	 *
	 * @since chro 1.0
	 *
	 * @param int $saturation Color saturation level.
	 */
	$saturation         = absint( apply_filters( 'chro_custom_colors_saturation', 50 ) );
...
.colors-custom.page:not(.chro-front-page) .entry-title,
...
.colors-custom .chro-panel .recent-posts .entry-header .edit-link {
...
.colors-custom.chro-front-page .panel-content .recent-posts article,
...
.colors-custom.chro-front-page article:not(.has-post-thumbnail):not(:first-child),
...
@media screen and (min-width: 48em) {
	...
	/**
	 * Filters chro custom colors CSS.
	 *
	 * @since chro 1.0
	 *
	 ...
	 */
	return apply_filters( 'chro_custom_colors_css', $css, $hue, $saturation );
}
