...
<div id="page-banner-area" class="page-banner-area" style="background-image:url('<?php echo get_template_directory_uri(); ?>/assets/images/hero_area/banner_bg.jpg');'">
      ...
      <section class="ts-pricing classic">
                  ...
                  <div class="ts-pricing-item disebled">
                     <div class="ts-pricing-header">
                        ...
                        <h3 class="ts-pricing-price">
                           <img class="currency" src="<?php echo get_template_directory_uri(); ?>/assets/images/pricing/dollar.png" alt="">
                           <span>39.9</span>
                        </h3>
                     </div>
                     <p>
         ...
         <div class="speaker-shap">
            <img class="shap2" src="<?php echo get_template_directory_uri(); ?>/assets/images/shap/pricing_memphis1.png" alt="">
         </div>
      </section>
